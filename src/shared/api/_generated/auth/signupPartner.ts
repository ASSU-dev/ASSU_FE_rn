 ...
 * JSON 형식의 제휴업체 가입 정보
 */
export interface PartnerSignUpRequestDTO {
	/**
	 * 휴대폰 번호
...
export type SignupPartnerBody = {
	request: PartnerSignUpRequestDTO;
	/** 사업자등록증 이미지 파일 */
	licenseImage: Blob;
};
...
export const getAssuApi = () => {
	/**
 * # [v1.2 (2025-09-13)](https://clumsy-seeder-416.notion.site/2501197c19ed80d7a8f2c3a6fcd8b537)
 ...
 */
	const signupPartner = (signupPartnerBody: SignupPartnerBody) => {
		const formData = new FormData();
		formData.append(`request`, JSON.stringify(signupPartnerBody.request));
		formData.append(`licenseImage`, signupPartnerBody.licenseImage);

		return customInstance<BaseResponseSignUpResponseDTO>({
			url: `/auth/partners/signup`,
			method: "POST",
...
export type SignupPartnerResult = NonNullable<
	Awaited<ReturnType<ReturnType<typeof getAssuApi>["signupPartner"]>>
>;
